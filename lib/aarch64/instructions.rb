module AArch64
  module Instructions
    ...
    autoload :CINC_CSINC, "aarch64/instructions/cinc_csinc"
    ...
    autoload :CMN_ADDS_addsub_ext, "aarch64/instructions/cmn_adds_addsub_ext"
    autoload :CMN_ADDS_addsub_imm, "aarch64/instructions/cmn_adds_addsub_imm"
    autoload :CMN_ADDS_addsub_shift, "aarch64/instructions/cmn_adds_addsub_shift"
    autoload :CMP_SUBS_addsub_ext, "aarch64/instructions/cmp_subs_addsub_ext"
    autoload :CMP_SUBS_addsub_imm, "aarch64/instructions/cmp_subs_addsub_imm"
    autoload :CMP_SUBS_addsub_shift, "aarch64/instructions/cmp_subs_addsub_shift"
    autoload :CMPP_SUBPS, "aarch64/instructions/cmpp_subps"
    autoload :CNEG_CSNEG, "aarch64/instructions/cneg_csneg"
    ...
    autoload :CPYFPRT, "aarch64/instructions/cpyfprt"
    autoload :CPYFPRTN, "aarch64/instructions/cpyfprtn"
    autoload :CPYFPRTRN, "aarch64/instructions/cpyfprtrn"
    autoload :CPYFPRTWN, "aarch64/instructions/cpyfprtwn"
    autoload :CPYFPT, "aarch64/instructions/cpyfpt"
    autoload :CPYFPTN, "aarch64/instructions/cpyfptn"
    autoload :CPYFPTRN, "aarch64/instructions/cpyfptrn"
    autoload :CPYFPTWN, "aarch64/instructions/cpyfptwn"
    autoload :CPYFPWN, "aarch64/instructions/cpyfpwn"
    autoload :CPYFPWT, "aarch64/instructions/cpyfpwt"
    autoload :CPYFPWTN, "aarch64/instructions/cpyfpwtn"
    autoload :CPYFPWTRN, "aarch64/instructions/cpyfpwtrn"
    autoload :CPYFPWTWN, "aarch64/instructions/cpyfpwtwn"
    autoload :CPYP, "aarch64/instructions/cpyp"
    autoload :CPYPN, "aarch64/instructions/cpypn"
    autoload :CPYPRN, "aarch64/instructions/cpyprn"
    autoload :CPYPRT, "aarch64/instructions/cpyprt"
    autoload :CPYPRTN, "aarch64/instructions/cpyprtn"
    autoload :CPYPRTRN, "aarch64/instructions/cpyprtrn"
    autoload :CPYPRTWN, "aarch64/instructions/cpyprtwn"
    autoload :CPYPT, "aarch64/instructions/cpypt"
    autoload :CPYPTN, "aarch64/instructions/cpyptn"
    autoload :CPYPTRN, "aarch64/instructions/cpyptrn"
    autoload :CPYPTWN, "aarch64/instructions/cpyptwn"
    autoload :CPYPWN, "aarch64/instructions/cpypwn"
    autoload :CPYPWT, "aarch64/instructions/cpypwt"
    autoload :CPYPWTN, "aarch64/instructions/cpypwtn"
    autoload :CPYPWTRN, "aarch64/instructions/cpypwtrn"
    autoload :CPYPWTWN, "aarch64/instructions/cpypwtwn"
