module AArch64
  module Instructions
    ...
    autoload :ADDS, "aarch64/instructions/adds"
    autoload :ADR, "aarch64/instructions/adr"
    autoload :ADRP, "aarch64/instructions/adrp"
    autoload :AND, "aarch64/instructions/and"
    autoload :ANDS, "aarch64/instructions/ands"
    ...
    autoload :EOR, "aarch64/instructions/eor"
    ...
    autoload :ORN, "aarch64/instructions/orn"
    autoload :ORR, "aarch64/instructions/orr"
