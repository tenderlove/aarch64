module AArch64
  module SystemRegisters
    ...
    PStateField = Struct.new(:op0, :op1, :CRn, :CRm, :op2, :imm_op1, :imm_op2)
    ...
    SPSel = PStateField.new(0b11, 0b000, 0b0100, 0b0010, 0b000, 0, 5)
    CurrentEL = MRS_MSR_64.new(0b11, 0b000, 0b0100, 0b0010, 0b010)
    PAN = PStateField.new(0b11, 0b000, 0b0100, 0b0010, 0b011, 0, 4)
    UAO = PStateField.new(0b11, 0b000, 0b0100, 0b0010, 0b100, 0, 3)
    ...
    DAIFSet = PStateField.new(nil, nil, nil, nil, nil, 3, 6)
    DAIFClr = PStateField.new(nil, nil, nil, nil, nil, 3, 7)
