...
class ParserTest < AArch64::Test
  ...
  def test_msr
    ...
    assert_bytes "msr daifset, #0", [0xdf, 0x40, 0x03, 0xd5]
    assert_bytes "msr spsel, #0", [0xbf, 0x40, 0x00, 0xd5]
    assert_bytes "msr pan, #1", [0x9f, 0x41, 0x00, 0xd5]
    assert_bytes "msr uao, #1", [0x7f, 0x41, 0x00, 0xd5]
  end
  ...
  def test_generated_ldr
    ...
    assert_bytes "ldr      x12, [x10, #0x1]", [0x4c, 0x11, 0x40, 0xf8]
    assert_bytes "ldr      x12, [x10, #0x9]", [0x4c, 0x91, 0x40, 0xf8]
  ...
  def test_generated_ldrh
    ...
    assert_bytes "ldrh     w12, [x10, #0x1]", [0x4c, 0x11, 0x40, 0x78]
    assert_bytes "ldrh     w12, [x10, #0x9]", [0x4c, 0x91, 0x40, 0x78]
