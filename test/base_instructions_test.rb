...
class BaseInstructionsTest < AArch64::Test
  ...
  def test_SUB_all
    ...
    assert_bytes [0x83,0x00,0x10,0x51] do |asm|
      asm.sub w3, w4, 1024
    end
    assert_bytes [0x83,0x00,0x10,0x51] do |asm|
      asm.sub w3, w4, 1024
    end
    assert_bytes [0x83,0x00,0x50,0x51] do |asm|
      asm.sub w3, w4, 1024, lsl(12)
    end
    assert_bytes [0x83,0x00,0x10,0xd1] do |asm|
      asm.sub x3, x4, 1024
    end
    assert_bytes [0x83,0x00,0x10,0xd1] do |asm|
      asm.sub x3, x4, 1024
    end
    assert_bytes [0x83,0x00,0x50,0xd1] do |asm|
      asm.sub x3, x4, 1024, lsl(12)
    end
    assert_bytes [0xff,0x83,0x00,0xd1] do |asm|
      asm.sub sp, sp, 32
    end
    assert_bytes [0xac,0x01,0x0e,0x4b] do |asm|
      asm.sub w12, w13, w14
    end
    assert_bytes [0xac,0x01,0x0e,0xcb] do |asm|
      asm.sub x12, x13, x14
    end
    assert_bytes [0xac,0x31,0x0e,0x4b] do |asm|
      asm.sub w12, w13, w14, lsl(12)
    end
    assert_bytes [0xac,0x31,0x0e,0xcb] do |asm|
      asm.sub x12, x13, x14, lsl(12)
    end
    assert_bytes [0xac,0xa9,0x4e,0xcb] do |asm|
      asm.sub x12, x13, x14, lsr(42)
    end
    assert_bytes [0xac,0x9d,0x8e,0xcb] do |asm|
      asm.sub x12, x13, x14, asr(39)
    end
    assert_bytes [0x41,0x00,0x23,0x4b] do |asm|
      asm.sub w1, w2, w3, uxtb
    end
    assert_bytes [0x41,0x20,0x23,0x4b] do |asm|
      asm.sub w1, w2, w3, uxth
    end
    assert_bytes [0x41,0x40,0x23,0x4b] do |asm|
      asm.sub w1, w2, w3, uxtw
    end
    assert_bytes [0x41,0x60,0x23,0x4b] do |asm|
      asm.sub w1, w2, w3, uxtx
    end
    assert_bytes [0x41,0x80,0x23,0x4b] do |asm|
      asm.sub w1, w2, w3, sxtb
    end
    assert_bytes [0x41,0xa0,0x23,0x4b] do |asm|
      asm.sub w1, w2, w3, sxth
    end
    assert_bytes [0x41,0xc0,0x23,0x4b] do |asm|
      asm.sub w1, w2, w3, sxtw
    end
    assert_bytes [0x41,0xe0,0x23,0x4b] do |asm|
      asm.sub w1, w2, w3, sxtx
    end
    assert_bytes [0x41,0x00,0x23,0xcb] do |asm|
      asm.sub x1, x2, w3, uxtb
    end
    assert_bytes [0x41,0x20,0x23,0xcb] do |asm|
      asm.sub x1, x2, w3, uxth
    end
    assert_bytes [0x41,0x40,0x23,0xcb] do |asm|
      asm.sub x1, x2, w3, uxtw
    end
    assert_bytes [0x41,0x80,0x23,0xcb] do |asm|
      asm.sub x1, x2, w3, sxtb
    end
    assert_bytes [0x41,0xa0,0x23,0xcb] do |asm|
      asm.sub x1, x2, w3, sxth
    end
    assert_bytes [0x41,0xc0,0x23,0xcb] do |asm|
      asm.sub x1, x2, w3, sxtw
    end
    assert_bytes [0xe1,0x43,0x23,0x4b] do |asm|
      asm.sub w1, wsp, w3
    end
    assert_bytes [0xe1,0x43,0x23,0x4b] do |asm|
      asm.sub w1, wsp, w3
    end
    assert_bytes [0x5f,0x60,0x23,0xcb] do |asm|
      asm.sub sp, x2, x3
    end
    assert_bytes [0x5f,0x60,0x23,0xcb] do |asm|
      asm.sub sp, x2, x3
    end
    assert_bytes [0x3f,0x41,0x28,0x4b] do |asm|
      asm.sub wsp, w9, w8
    end
    assert_bytes [0xe1,0x43,0x28,0x4b] do |asm|
      asm.sub w1, wsp, w8
    end
    assert_bytes [0xff,0x43,0x28,0x4b] do |asm|
      asm.sub wsp, wsp, w8
    end
    assert_bytes [0x3f,0x41,0x28,0xcb] do |asm|
      asm.sub sp, x9, w8, uxtw
    end
    assert_bytes [0xe1,0x43,0x28,0xcb] do |asm|
      asm.sub x1, sp, w8, uxtw
    end
    assert_bytes [0xff,0x43,0x28,0xcb] do |asm|
      asm.sub sp, sp, w8, uxtw
    end
    assert_bytes [0x82,0x08,0x25,0xcb] do |asm|
      asm.sub      x2, x4, w5, uxtb(2)
    end
